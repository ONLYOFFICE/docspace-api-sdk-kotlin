...
| **capabilities** | [**java.math.BigDecimal**](java.math.BigDecimal.md) | Bitmask of model capabilities (Chat, Image, Vision, Tools, etc.). Used to filter models per  {@link  ActionType  } . |  [optional] |
