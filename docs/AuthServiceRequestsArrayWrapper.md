...
| ------------ | ------------- | ------------- | ------------- |
| **response** | [**kotlin.collections.List&lt;AuthServiceRequestsDto&gt;**](AuthServiceRequestsDto.md) | The list of AuthServiceRequestsDto objects returned by the operation. |  [optional] |
