...
apiClient.setBearerToken("TOKEN")
val webService = apiClient.createWebservice(WebhooksApi::class.java)
val deliveryFrom : java.time.OffsetDateTime = 2024-01-15T10:30:00Z // java.time.OffsetDateTime | The delivery start time for filtering webhook logs.
val deliveryTo : java.time.OffsetDateTime = 2024-01-15T10:30:00Z // java.time.OffsetDateTime | The delivery end time for filtering webhook logs.
...
val userId : java.util.UUID = {} // java.util.UUID | The identifier of the user associated with the webhook event.
