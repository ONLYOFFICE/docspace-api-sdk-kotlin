...
| ------------ | ------------- | ------------- | ------------- |
| **response** | [**kotlin.collections.List&lt;GroupMemberSecurityRequestDto&gt;**](GroupMemberSecurityRequestDto.md) | The list of GroupMemberSecurityRequestDto objects returned by the operation. |  [optional] |
...
| **statusCode** | **kotlin.Int** | HTTP status code of the response (duplicate of status) |  [optional] |
