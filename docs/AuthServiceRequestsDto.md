...
| ------------ | ------------- | ------------- | ------------- |
| **name** | **kotlin.String** | The name of the authorization service. |  [optional] |
| **title** | **kotlin.String** | The user-friendly display title of the authorization service. |  [optional] |
