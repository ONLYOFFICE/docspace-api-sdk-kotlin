...
| ------------ | ------------- | ------------- | ------------- |
| **response** | [**kotlin.collections.List&lt;AiNewItemsDtoAgentNewItemsDto&gt;**](AiNewItemsDtoAgentNewItemsDto.md) | The list of NewItemsDtoAgentNewItemsDto objects returned by the operation. |  [optional] |
