...
| **from** | **java.time.OffsetDateTime**| The starting date and time for filtering audit events. | [optional] |
| **to** | **java.time.OffsetDateTime**| The ending date and time for filtering audit events. | [optional] |
...
apiClient.setBearerToken("TOKEN")
val webService = apiClient.createWebservice(AuditTrailDataApi::class.java)
val userId : java.util.UUID = 00000000-0000-0000-0000-000000000001 // java.util.UUID | The ID of the user who triggered the audit event.
val moduleType : LocationType = Files // LocationType | The location where the audit event occurred.
val actionType : ActionType = Create // ActionType | The type of action performed in the audit event (e.g., Create, Update, Delete).
val action : MessageAction = FileCreated // MessageAction | The specific action that occurred within the audit event.
val entryType : EntryType = File // EntryType | The type of audit entry (e.g., Folder, User, File).
val target : kotlin.String = document.docx // kotlin.String | The target object affected by the audit event (e.g., document ID, user account).
val from : java.time.OffsetDateTime = 2024-01-01T00:00:00Z // java.time.OffsetDateTime | The starting date and time for filtering audit events.
val to : java.time.OffsetDateTime = 2024-01-31T23:59:59Z // java.time.OffsetDateTime | The ending date and time for filtering audit events.
