...
| **site** | [**java.net.URI**](java.net.URI.md) | The company site. |  [optional] |
| **email** | **kotlin.String** | The company email address. |  [optional] |
| **address** | **kotlin.String** | The company address. |  [optional] |
