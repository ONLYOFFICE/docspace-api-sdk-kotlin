...
| ------------ | ------------- | ------------- | ------------- |
| **response** | [**kotlin.collections.List&lt;NewItemsDtoFileEntryBaseDto&gt;**](NewItemsDtoFileEntryBaseDto.md) | The list of NewItemsDtoFileEntryBaseDto objects returned by the operation. |  [optional] |
