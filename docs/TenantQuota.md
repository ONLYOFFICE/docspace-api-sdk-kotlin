...
| **additional** | **kotlin.Boolean** | Specifies if the tenant quota is primary or additional. |  [optional] |
...
| **backup** | **kotlin.Boolean** | Specifies if the backup enabled as a wallet service or not. |  [optional] |
