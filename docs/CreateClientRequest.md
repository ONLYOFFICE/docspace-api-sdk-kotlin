...
| ------------ | ------------- | ------------- | ------------- |
| **redirectUris** | **kotlin.collections.Set&lt;kotlin.String&gt;** | The list of allowed redirect URIs. |  |
| **allowedOrigins** | **kotlin.collections.Set&lt;kotlin.String&gt;** | The list of allowed CORS origins. |  |
| **name** | **kotlin.String** | The client name. |  [optional] |
| **description** | **kotlin.String** | The client description. |  [optional] |
| **logo** | **kotlin.String** | The client logo in base64 format. |  [optional] |
