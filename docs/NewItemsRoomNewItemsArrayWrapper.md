...
| ------------ | ------------- | ------------- | ------------- |
| **response** | [**kotlin.collections.List&lt;NewItemsDtoRoomNewItemsDto&gt;**](NewItemsDtoRoomNewItemsDto.md) | The list of NewItemsDtoRoomNewItemsDto objects returned by the operation. |  [optional] |
