...
> DocumentBuilderTaskWrapper createLoginHistoryReport (AuditReportFormat format)
...
launch(Dispatchers.IO) {
    val result : DocumentBuilderTaskWrapper = webService.createLoginHistoryReport(format)
}
```
...
> LoginEventArrayWrapper getLoginEventsByFilter (java.util.UUID userId, MessageAction action, java.time.OffsetDateTime from, java.time.OffsetDateTime to, kotlin.Int count, kotlin.Int startIndex)
...
| **from** | **java.time.OffsetDateTime**| The starting date and time for filtering login events. | [optional] |
| **to** | **java.time.OffsetDateTime**| The ending date and time for filtering login events. | [optional] |
...
val from : java.time.OffsetDateTime = 2024-01-15T10:30:00Z // java.time.OffsetDateTime | The starting date and time for filtering login events.
val to : java.time.OffsetDateTime = 2024-01-15T10:30:00Z // java.time.OffsetDateTime | The ending date and time for filtering login events.
...
launch(Dispatchers.IO) {
    val result : DocumentBuilderTaskWrapper = webService.getLoginHistoryReport()
}
```
...
launch(Dispatchers.IO) {
    webService.terminateLoginHistoryReport()
}
```
