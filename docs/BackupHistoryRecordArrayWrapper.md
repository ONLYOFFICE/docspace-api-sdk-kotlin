...
| ------------ | ------------- | ------------- | ------------- |
| **response** | [**kotlin.collections.List&lt;BackupHistoryRecord&gt;**](BackupHistoryRecord.md) | The list of BackupHistoryRecord objects returned by the operation. |  [optional] |
