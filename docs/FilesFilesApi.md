...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **fileId** | **kotlin.Int**| File ID | |
| **accessRequestKeyDto** | [**kotlin.collections.List&lt;AccessRequestKeyDto&gt;**](AccessRequestKeyDto.md)| Collection of encryption key data for users with access to the file | [optional] |
...
apiClient.setBearerToken("TOKEN")
val webService = apiClient.createWebservice(FilesApi::class.java)
val fileId : kotlin.Int = 12345 // kotlin.Int | File ID
val accessRequestKeyDto : kotlin.collections.List<AccessRequestKeyDto> =  // kotlin.collections.List<AccessRequestKeyDto> | Collection of encryption key data for users with access to the file
