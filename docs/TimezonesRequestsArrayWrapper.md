...
| ------------ | ------------- | ------------- | ------------- |
| **response** | [**kotlin.collections.List&lt;TimezonesRequestsDto&gt;**](TimezonesRequestsDto.md) | The list of TimezonesRequestsDto objects returned by the operation. |  [optional] |
