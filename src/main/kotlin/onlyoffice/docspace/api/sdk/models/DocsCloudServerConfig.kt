...
data class DocsCloudServerConfig (

    @Json(name = "isAnonymousSupport")
    val isAnonymousSupport: kotlin.Boolean? = null,

    @Json(name = "fileSizeLimit")
    val fileSizeLimit: kotlin.Long? = null
