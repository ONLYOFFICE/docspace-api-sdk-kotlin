...
import onlyoffice.docspace.api.sdk.models.CustomerMonthlyUsageDto
 ...
 *
 * @param response The list of CustomerMonthlyUsageDto objects returned by the operation.
...
data class CustomerMonthlyUsageArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<CustomerMonthlyUsageDto>? = null,
