...
import onlyoffice.docspace.api.sdk.models.AuditEventDto
 ...
 *
 * @param response The list of AuditEventDto objects returned by the operation.
...
data class AuditEventArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<AuditEventDto>? = null,
