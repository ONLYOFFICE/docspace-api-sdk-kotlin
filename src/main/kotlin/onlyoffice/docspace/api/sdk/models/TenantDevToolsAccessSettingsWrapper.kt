...
import onlyoffice.docspace.api.sdk.models.TenantDevToolsAccessSettings
 ...
 *
 * @param response The TenantDevToolsAccessSettings object returned by the operation.
...
data class TenantDevToolsAccessSettingsWrapper (

    @Json(name = "response")
    val response: TenantDevToolsAccessSettings? = null,
