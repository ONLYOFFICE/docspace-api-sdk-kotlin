...
import onlyoffice.docspace.api.sdk.models.IsDefaultWhiteLabelLogosDto
 ...
 *
 * @param response The list of IsDefaultWhiteLabelLogosDto objects returned by the operation.
...
data class IsDefaultWhiteLabelLogosArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<IsDefaultWhiteLabelLogosDto>? = null,
