...
import onlyoffice.docspace.api.sdk.models.FillingFormResultDtoInteger
 ...
 *
 * @param response The FillingFormResultDtoInteger object returned by the operation.
...
data class FillingFormResultIntegerWrapper (

    @Json(name = "response")
    val response: FillingFormResultDtoInteger? = null,
