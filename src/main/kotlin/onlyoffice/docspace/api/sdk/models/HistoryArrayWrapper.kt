...
import onlyoffice.docspace.api.sdk.models.HistoryDto
 ...
 *
 * @param response The list of HistoryDto objects returned by the operation.
...
data class HistoryArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<HistoryDto>? = null,
