...
import onlyoffice.docspace.api.sdk.models.FileUploadResultDto
 ...
 *
 * @param response The FileUploadResultDto object returned by the operation.
...
data class FileUploadResultWrapper (

    @Json(name = "response")
    val response: FileUploadResultDto? = null,
