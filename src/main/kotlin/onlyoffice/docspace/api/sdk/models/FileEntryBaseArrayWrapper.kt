 ...
 *
 * @param response The list of FileEntryBaseDto objects returned by the operation.
...
data class FileEntryBaseArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<FileEntryBaseDto>? = null,
