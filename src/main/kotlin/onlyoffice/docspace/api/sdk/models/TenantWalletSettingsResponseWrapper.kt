...
import onlyoffice.docspace.api.sdk.models.TenantWalletSettings
 ...
 *
 * @param response The TenantWalletSettings object returned by the operation.
...
data class TenantWalletSettingsResponseWrapper (

    @Json(name = "response")
    val response: TenantWalletSettings? = null,
