...
import onlyoffice.docspace.api.sdk.models.RoomGroupDto
 ...
 *
 * @param response The list of RoomGroupDto objects returned by the operation.
...
data class RoomGroupArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<RoomGroupDto>? = null,
