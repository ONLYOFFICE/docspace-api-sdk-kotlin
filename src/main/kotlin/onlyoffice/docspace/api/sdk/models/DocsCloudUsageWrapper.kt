...
import onlyoffice.docspace.api.sdk.models.DocsCloudUsage
 ...
 *
 * @param response The DocsCloudUsage object returned by the operation.
...
data class DocsCloudUsageWrapper (

    @Json(name = "response")
    val response: DocsCloudUsage? = null,
