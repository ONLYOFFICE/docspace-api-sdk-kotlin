 ...
 *
 * @param response The list of EmployeeFullDto objects returned by the operation.
...
data class EmployeeFullArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<EmployeeFullDto>? = null,
