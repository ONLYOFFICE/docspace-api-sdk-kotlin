...
import onlyoffice.docspace.api.sdk.models.AiFileOperationDto
 ...
 *
 * @param response The FileOperationDto object returned by the operation.
...
data class AiFileOperationWrapper (

    @Json(name = "response")
    val response: AiFileOperationDto? = null,
