...
import onlyoffice.docspace.api.sdk.models.ApiKeyResponseDto
 ...
 *
 * @param response The list of ApiKeyResponseDto objects returned by the operation.
...
data class ApiKeyResponseArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<ApiKeyResponseDto>? = null,
