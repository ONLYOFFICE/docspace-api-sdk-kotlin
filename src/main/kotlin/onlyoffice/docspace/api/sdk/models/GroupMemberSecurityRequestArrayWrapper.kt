...
import onlyoffice.docspace.api.sdk.models.GroupMemberSecurityRequestDto
 ...
 *
 * @param response The list of GroupMemberSecurityRequestDto objects returned by the operation.
...
data class GroupMemberSecurityRequestArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<GroupMemberSecurityRequestDto>? = null,
