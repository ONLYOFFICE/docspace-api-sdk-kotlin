...
import onlyoffice.docspace.api.sdk.models.ExternalShareDto
 ...
 *
 * @param response The ExternalShareDto object returned by the operation.
...
data class ExternalShareWrapper (

    @Json(name = "response")
    val response: ExternalShareDto? = null,
