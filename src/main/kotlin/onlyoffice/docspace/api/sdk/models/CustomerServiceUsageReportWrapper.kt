...
import onlyoffice.docspace.api.sdk.models.CustomerServiceUsageReportDto
 ...
 *
 * @param response The CustomerServiceUsageReportDto object returned by the operation.
...
data class CustomerServiceUsageReportWrapper (

    @Json(name = "response")
    val response: CustomerServiceUsageReportDto? = null,
