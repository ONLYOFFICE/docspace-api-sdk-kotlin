...
import onlyoffice.docspace.api.sdk.models.StorageSettings
 ...
 *
 * @param response The StorageSettings object returned by the operation.
...
data class StorageSettingsWrapper (

    @Json(name = "response")
    val response: StorageSettings? = null,
