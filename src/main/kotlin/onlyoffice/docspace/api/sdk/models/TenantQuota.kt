 ...
 * @param additional Specifies if the tenant quota is primary or additional.
...
data class TenantQuota (
    ...
    @Json(name = "aiSearch")
    val aiSearch: kotlin.Boolean? = null,

    @Json(name = "docsCloud")
    val docsCloud: kotlin.Int? = null,

    @Json(name = "docsCloudDevPack")
    val docsCloudDevPack: kotlin.Boolean? = null,

    @Json(name = "docsCloudTrial")
    val docsCloudTrial: kotlin.Boolean? = null
