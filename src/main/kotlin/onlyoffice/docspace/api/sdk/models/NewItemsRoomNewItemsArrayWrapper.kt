...
import onlyoffice.docspace.api.sdk.models.NewItemsDtoRoomNewItemsDto
 ...
 *
 * @param response The list of NewItemsDtoRoomNewItemsDto objects returned by the operation.
...
data class NewItemsRoomNewItemsArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<NewItemsDtoRoomNewItemsDto>? = null,
