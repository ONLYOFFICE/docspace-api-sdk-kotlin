...
import onlyoffice.docspace.api.sdk.models.FormSubmissionsDto
 ...
 *
 * @param response The FormSubmissionsDto object returned by the operation.
...
data class FormSubmissionsWrapper (

    @Json(name = "response")
    val response: FormSubmissionsDto? = null,
