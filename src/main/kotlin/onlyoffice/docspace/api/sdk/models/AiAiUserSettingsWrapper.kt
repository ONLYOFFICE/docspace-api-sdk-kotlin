...
import onlyoffice.docspace.api.sdk.models.AiAiUserSettingsDto
 ...
 *
 * @param response The AiUserSettingsDto object returned by the operation.
...
data class AiAiUserSettingsWrapper (

    @Json(name = "response")
    val response: AiAiUserSettingsDto? = null,
