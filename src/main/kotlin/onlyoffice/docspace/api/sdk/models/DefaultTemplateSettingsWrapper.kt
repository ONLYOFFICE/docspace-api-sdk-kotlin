...
import onlyoffice.docspace.api.sdk.models.DefaultTemplateSettingsDto
 ...
 *
 * @param response The DefaultTemplateSettingsDto object returned by the operation.
...
data class DefaultTemplateSettingsWrapper (

    @Json(name = "response")
    val response: DefaultTemplateSettingsDto? = null,
