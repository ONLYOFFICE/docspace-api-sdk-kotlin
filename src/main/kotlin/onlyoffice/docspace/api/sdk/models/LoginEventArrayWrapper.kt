...
import onlyoffice.docspace.api.sdk.models.LoginEventDto
 ...
 *
 * @param response The list of LoginEventDto objects returned by the operation.
...
data class LoginEventArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<LoginEventDto>? = null,
