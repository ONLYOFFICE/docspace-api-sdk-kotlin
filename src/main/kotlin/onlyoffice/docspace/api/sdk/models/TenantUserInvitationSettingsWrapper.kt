...
import onlyoffice.docspace.api.sdk.models.TenantUserInvitationSettingsDto
 ...
 *
 * @param response The TenantUserInvitationSettingsDto object returned by the operation.
...
data class TenantUserInvitationSettingsWrapper (

    @Json(name = "response")
    val response: TenantUserInvitationSettingsDto? = null,
