 ...
 *
 * @param response The IsDefaultWhiteLabelLogosDto object returned by the operation.
...
data class IsDefaultWhiteLabelLogosWrapper (

    @Json(name = "response")
    val response: IsDefaultWhiteLabelLogosDto? = null,
