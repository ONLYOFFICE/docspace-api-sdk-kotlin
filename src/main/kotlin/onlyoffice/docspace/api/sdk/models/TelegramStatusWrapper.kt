...
import onlyoffice.docspace.api.sdk.models.TelegramStatusDto
 ...
 *
 * @param response The TelegramStatusDto object returned by the operation.
...
data class TelegramStatusWrapper (

    @Json(name = "response")
    val response: TelegramStatusDto? = null,
