...
import onlyoffice.docspace.api.sdk.models.TfaAppCodeDto
 ...
 *
 * @param response The list of TfaAppCodeDto objects returned by the operation.
...
data class TfaAppCodeArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<TfaAppCodeDto>? = null,
