...
import onlyoffice.docspace.api.sdk.models.WalletServiceDto
 ...
 *
 * @param response The list of WalletServiceDto objects returned by the operation.
...
data class WalletServiceArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<WalletServiceDto>? = null,
