...
import onlyoffice.docspace.api.sdk.models.TfaConfirmDataDto
 ...
 *
 * @param response The TfaConfirmDataDto object returned by the operation.
...
data class TfaConfirmDataWrapper (

    @Json(name = "response")
    val response: TfaConfirmDataDto? = null,
