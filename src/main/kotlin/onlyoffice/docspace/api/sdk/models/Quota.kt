 ...
 * @param additional Indicates whether the quota is primary or additional.
 * @param nextQuota The quota ID to switch to at the next period.
 * @param state The quota state.
 */
