...
import onlyoffice.docspace.api.sdk.models.TfaSettingsDto
 ...
 *
 * @param response The list of TfaSettingsDto objects returned by the operation.
...
data class TfaSettingsArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<TfaSettingsDto>? = null,
