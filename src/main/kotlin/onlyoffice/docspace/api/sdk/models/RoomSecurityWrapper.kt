...
import onlyoffice.docspace.api.sdk.models.RoomSecurityDto
 ...
 *
 * @param response The RoomSecurityDto object returned by the operation.
...
data class RoomSecurityWrapper (

    @Json(name = "response")
    val response: RoomSecurityDto? = null,
