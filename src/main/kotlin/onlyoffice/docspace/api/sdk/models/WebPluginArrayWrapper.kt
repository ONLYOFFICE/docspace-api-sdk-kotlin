...
import onlyoffice.docspace.api.sdk.models.WebPluginDto
 ...
 *
 * @param response The list of WebPluginDto objects returned by the operation.
...
data class WebPluginArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<WebPluginDto>? = null,
