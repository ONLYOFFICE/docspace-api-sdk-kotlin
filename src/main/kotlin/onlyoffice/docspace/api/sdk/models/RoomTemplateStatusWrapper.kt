...
import onlyoffice.docspace.api.sdk.models.RoomTemplateStatusDto
 ...
 *
 * @param response The RoomTemplateStatusDto object returned by the operation.
...
data class RoomTemplateStatusWrapper (

    @Json(name = "response")
    val response: RoomTemplateStatusDto? = null,
