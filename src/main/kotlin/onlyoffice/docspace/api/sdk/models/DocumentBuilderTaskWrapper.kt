 ...
 *
 * @param response The DocumentBuilderTaskDto object returned by the operation.
...
data class DocumentBuilderTaskWrapper (

    @Json(name = "response")
    val response: DocumentBuilderTaskDto? = null,
