...
import onlyoffice.docspace.api.sdk.models.WebhooksLogDto
 ...
 *
 * @param response The list of WebhooksLogDto objects returned by the operation.
...
data class WebhooksLogArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<WebhooksLogDto>? = null,
