...
enum class AiFolderType(val value: kotlin.Int) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is AiFolderType) "$data" else null

        /**
         * Returns a valid [AiFolderType] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): AiFolderType? = data?.let {
