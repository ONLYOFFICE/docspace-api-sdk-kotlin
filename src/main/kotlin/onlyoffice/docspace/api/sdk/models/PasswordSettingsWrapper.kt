...
import onlyoffice.docspace.api.sdk.models.PasswordSettingsDto
 ...
 *
 * @param response The PasswordSettingsDto object returned by the operation.
...
data class PasswordSettingsWrapper (

    @Json(name = "response")
    val response: PasswordSettingsDto? = null,
