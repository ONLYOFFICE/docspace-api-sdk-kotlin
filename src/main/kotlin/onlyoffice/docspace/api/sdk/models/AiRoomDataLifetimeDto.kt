...
import onlyoffice.docspace.api.sdk.models.AiRoomDataLifetimePeriod
 ...
 * @param period Specifies the time period type of the room data lifetime.
...
data class AiRoomDataLifetimeDto (

    @Json(name = "deletePermanently")
    val deletePermanently: kotlin.Boolean? = null,

    @Json(name = "period")
    val period: AiRoomDataLifetimePeriod? = null,
