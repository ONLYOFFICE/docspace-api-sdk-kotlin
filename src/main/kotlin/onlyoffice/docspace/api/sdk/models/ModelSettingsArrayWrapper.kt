...
import onlyoffice.docspace.api.sdk.models.ModelSettingsDto
...
data class ModelSettingsArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<ModelSettingsDto>? = null,
