...
import onlyoffice.docspace.api.sdk.models.NewItemsDtoAgentNewItemsDto
...
data class NewItemsAgentNewItemsArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<NewItemsDtoAgentNewItemsDto>? = null,
