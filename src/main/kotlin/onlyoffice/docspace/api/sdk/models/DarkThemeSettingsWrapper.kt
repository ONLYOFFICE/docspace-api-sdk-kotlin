...
import onlyoffice.docspace.api.sdk.models.DarkThemeSettings
 ...
 *
 * @param response The DarkThemeSettings object returned by the operation.
...
data class DarkThemeSettingsWrapper (

    @Json(name = "response")
    val response: DarkThemeSettings? = null,
