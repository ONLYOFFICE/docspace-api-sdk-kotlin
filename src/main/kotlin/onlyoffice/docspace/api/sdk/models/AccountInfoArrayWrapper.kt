...
import onlyoffice.docspace.api.sdk.models.AccountInfoDto
 ...
 *
 * @param response The list of AccountInfoDto objects returned by the operation.
...
data class AccountInfoArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<AccountInfoDto>? = null,
