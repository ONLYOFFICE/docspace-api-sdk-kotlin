...
import onlyoffice.docspace.api.sdk.models.FilesStatisticsResultDto
 ...
 *
 * @param response The FilesStatisticsResultDto object returned by the operation.
...
data class FilesStatisticsResultWrapper (

    @Json(name = "response")
    val response: FilesStatisticsResultDto? = null,
