...
import onlyoffice.docspace.api.sdk.models.ExternalSharingSettingsDto
 ...
 *
 * @param response The ExternalSharingSettingsDto object returned by the operation.
...
data class ExternalSharingSettingsWrapper (

    @Json(name = "response")
    val response: ExternalSharingSettingsDto? = null,
