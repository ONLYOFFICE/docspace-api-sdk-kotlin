...
import onlyoffice.docspace.api.sdk.models.WebhooksConfigWithStatusDto
 ...
 *
 * @param response The list of WebhooksConfigWithStatusDto objects returned by the operation.
...
data class WebhooksConfigWithStatusArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<WebhooksConfigWithStatusDto>? = null,
