...
import onlyoffice.docspace.api.sdk.models.AppDto
 ...
 *
 * @param response The list of AppDto objects returned by the operation.
...
data class AppArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<AppDto>? = null,
