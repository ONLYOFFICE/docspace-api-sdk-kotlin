...
import onlyoffice.docspace.api.sdk.models.EncryptionSettings
 ...
 *
 * @param response The EncryptionSettings object returned by the operation.
...
data class EncryptionSettingsWrapper (

    @Json(name = "response")
    val response: EncryptionSettings? = null,
