...
import onlyoffice.docspace.api.sdk.models.AiFolderContentDtoInteger
 ...
 *
 * @param response The FolderContentDtoInteger object returned by the operation.
...
data class AiFolderContentIntegerWrapper (

    @Json(name = "response")
    val response: AiFolderContentDtoInteger? = null,
