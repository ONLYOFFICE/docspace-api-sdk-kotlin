...
import onlyoffice.docspace.api.sdk.models.TenantDto
 ...
 *
 * @param response The TenantDto object returned by the operation.
...
data class TenantWrapper (

    @Json(name = "response")
    val response: TenantDto? = null,
