...
import onlyoffice.docspace.api.sdk.models.DocsCloudQuota
 ...
 *
 * @param response The DocsCloudQuota object returned by the operation.
...
data class DocsCloudQuotaWrapper (

    @Json(name = "response")
    val response: DocsCloudQuota? = null,
