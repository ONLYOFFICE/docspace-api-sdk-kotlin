...
import onlyoffice.docspace.api.sdk.models.FileEncryptionInfoDto
 ...
 *
 * @param response The FileEncryptionInfoDto object returned by the operation.
...
data class FileEncryptionInfoWrapper (

    @Json(name = "response")
    val response: FileEncryptionInfoDto? = null,
