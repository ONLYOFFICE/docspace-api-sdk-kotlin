...
import onlyoffice.docspace.api.sdk.models.WizardSettings
 ...
 *
 * @param response The WizardSettings object returned by the operation.
...
data class WizardSettingsWrapper (

    @Json(name = "response")
    val response: WizardSettings? = null,
