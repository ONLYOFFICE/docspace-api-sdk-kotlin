...
import onlyoffice.docspace.api.sdk.models.UpcomingPaymentDto
 ...
 *
 * @param response The list of UpcomingPaymentDto objects returned by the operation.
...
data class UpcomingPaymentArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<UpcomingPaymentDto>? = null,
