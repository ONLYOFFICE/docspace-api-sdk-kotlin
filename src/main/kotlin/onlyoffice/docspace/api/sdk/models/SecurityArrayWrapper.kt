...
import onlyoffice.docspace.api.sdk.models.SecurityDto
 ...
 *
 * @param response The list of SecurityDto objects returned by the operation.
...
data class SecurityArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<SecurityDto>? = null,
