...
import onlyoffice.docspace.api.sdk.models.ThumbnailsDataDto
 ...
 *
 * @param response The ThumbnailsDataDto object returned by the operation.
...
data class ThumbnailsDataWrapper (

    @Json(name = "response")
    val response: ThumbnailsDataDto? = null,
