...
import onlyoffice.docspace.api.sdk.models.SsoSettingsV2
 ...
 *
 * @param response The SsoSettingsV2 object returned by the operation.
...
data class SsoSettingsV2Wrapper (

    @Json(name = "response")
    val response: SsoSettingsV2? = null,
