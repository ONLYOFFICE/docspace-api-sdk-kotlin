...
import onlyoffice.docspace.api.sdk.models.McpServerStatusDto
...
data class McpServerStatusArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<McpServerStatusDto>? = null,
