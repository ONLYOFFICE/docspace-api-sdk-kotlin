...
import onlyoffice.docspace.api.sdk.models.MentionWrapper
 ...
 *
 * @param response The list of MentionWrapper objects returned by the operation.
...
data class MentionWrapperArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<MentionWrapper>? = null,
