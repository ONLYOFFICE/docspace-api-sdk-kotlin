...
import onlyoffice.docspace.api.sdk.models.BackupsCountResultDto
 ...
 *
 * @param response The BackupsCountResultDto object returned by the operation.
...
data class BackupsCountResultWrapper (

    @Json(name = "response")
    val response: BackupsCountResultDto? = null,
