...
import onlyoffice.docspace.api.sdk.models.TenantAiAgentQuotaSettings
 ...
 *
 * @param response The TenantAiAgentQuotaSettings object returned by the operation.
...
data class TenantAiAgentQuotaSettingsWrapper (

    @Json(name = "response")
    val response: TenantAiAgentQuotaSettings? = null,
