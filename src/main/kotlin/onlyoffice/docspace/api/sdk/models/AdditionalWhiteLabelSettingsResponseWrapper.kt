...
import onlyoffice.docspace.api.sdk.models.AdditionalWhiteLabelSettings
 ...
 *
 * @param response The AdditionalWhiteLabelSettings object returned by the operation.
...
data class AdditionalWhiteLabelSettingsResponseWrapper (

    @Json(name = "response")
    val response: AdditionalWhiteLabelSettings? = null,
