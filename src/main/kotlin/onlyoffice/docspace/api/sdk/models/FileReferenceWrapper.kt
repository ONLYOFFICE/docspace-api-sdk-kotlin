...
import onlyoffice.docspace.api.sdk.models.FileReference
 ...
 *
 * @param response The FileReference object returned by the operation.
...
data class FileReferenceWrapper (

    @Json(name = "response")
    val response: FileReference? = null,
