...
import onlyoffice.docspace.api.sdk.models.ProductAdministratorDto
 ...
 *
 * @param response The ProductAdministratorDto object returned by the operation.
...
data class ProductAdministratorWrapper (

    @Json(name = "response")
    val response: ProductAdministratorDto? = null,
