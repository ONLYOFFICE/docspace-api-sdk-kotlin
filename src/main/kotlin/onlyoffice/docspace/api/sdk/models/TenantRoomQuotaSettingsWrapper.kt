...
import onlyoffice.docspace.api.sdk.models.TenantRoomQuotaSettings
 ...
 *
 * @param response The TenantRoomQuotaSettings object returned by the operation.
...
data class TenantRoomQuotaSettingsWrapper (

    @Json(name = "response")
    val response: TenantRoomQuotaSettings? = null,
