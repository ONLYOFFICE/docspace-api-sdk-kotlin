...
import onlyoffice.docspace.api.sdk.models.FilesSettingsDto
 ...
 *
 * @param response The FilesSettingsDto object returned by the operation.
...
data class FilesSettingsWrapper (

    @Json(name = "response")
    val response: FilesSettingsDto? = null,
