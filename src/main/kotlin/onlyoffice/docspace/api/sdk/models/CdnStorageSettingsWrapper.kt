...
import onlyoffice.docspace.api.sdk.models.CdnStorageSettings
 ...
 *
 * @param response The CdnStorageSettings object returned by the operation.
...
data class CdnStorageSettingsWrapper (

    @Json(name = "response")
    val response: CdnStorageSettings? = null,
