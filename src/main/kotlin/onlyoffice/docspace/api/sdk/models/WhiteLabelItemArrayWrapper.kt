...
import onlyoffice.docspace.api.sdk.models.WhiteLabelItemDto
 ...
 *
 * @param response The list of WhiteLabelItemDto objects returned by the operation.
...
data class WhiteLabelItemArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<WhiteLabelItemDto>? = null,
