 ...
 *
 * @param response The list of AceShortWrapper objects returned by the operation.
...
data class AceShortWrapperArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<AceShortWrapper>? = null,
