...
import onlyoffice.docspace.api.sdk.models.EditHistoryDataDto
 ...
 *
 * @param response The EditHistoryDataDto object returned by the operation.
...
data class EditHistoryDataWrapper (

    @Json(name = "response")
    val response: EditHistoryDataDto? = null,
