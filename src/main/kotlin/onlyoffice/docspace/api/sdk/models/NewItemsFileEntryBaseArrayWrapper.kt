...
import onlyoffice.docspace.api.sdk.models.NewItemsDtoFileEntryBaseDto
 ...
 *
 * @param response The list of NewItemsDtoFileEntryBaseDto objects returned by the operation.
...
data class NewItemsFileEntryBaseArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<NewItemsDtoFileEntryBaseDto>? = null,
