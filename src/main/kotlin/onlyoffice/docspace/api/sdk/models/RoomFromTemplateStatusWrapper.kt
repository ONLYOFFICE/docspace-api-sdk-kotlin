...
import onlyoffice.docspace.api.sdk.models.RoomFromTemplateStatusDto
 ...
 *
 * @param response The RoomFromTemplateStatusDto object returned by the operation.
...
data class RoomFromTemplateStatusWrapper (

    @Json(name = "response")
    val response: RoomFromTemplateStatusDto? = null,
