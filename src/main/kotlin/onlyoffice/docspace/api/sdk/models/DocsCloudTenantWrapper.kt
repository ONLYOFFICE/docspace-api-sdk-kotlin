...
import onlyoffice.docspace.api.sdk.models.DocsCloudTenant
 ...
 *
 * @param response The DocsCloudTenant object returned by the operation.
...
data class DocsCloudTenantWrapper (

    @Json(name = "response")
    val response: DocsCloudTenant? = null,
