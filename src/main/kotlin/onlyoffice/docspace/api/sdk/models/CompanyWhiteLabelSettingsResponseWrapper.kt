 ...
 *
 * @param response The CompanyWhiteLabelSettings object returned by the operation.
...
data class CompanyWhiteLabelSettingsResponseWrapper (

    @Json(name = "response")
    val response: CompanyWhiteLabelSettings? = null,
