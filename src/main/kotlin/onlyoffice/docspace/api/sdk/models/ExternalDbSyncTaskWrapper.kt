...
import onlyoffice.docspace.api.sdk.models.ExternalDbSyncTaskDto
 ...
 *
 * @param response The ExternalDbSyncTaskDto object returned by the operation.
...
data class ExternalDbSyncTaskWrapper (

    @Json(name = "response")
    val response: ExternalDbSyncTaskDto? = null,
