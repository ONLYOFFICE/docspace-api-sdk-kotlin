...
import onlyoffice.docspace.api.sdk.models.BackupProgress
 ...
 *
 * @param response The BackupProgress object returned by the operation.
...
data class BackupProgressWrapper (

    @Json(name = "response")
    val response: BackupProgress? = null,
