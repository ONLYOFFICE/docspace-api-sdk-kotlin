...
import onlyoffice.docspace.api.sdk.models.DocServiceUrlDto
 ...
 *
 * @param response The DocServiceUrlDto object returned by the operation.
...
data class DocServiceUrlWrapper (

    @Json(name = "response")
    val response: DocServiceUrlDto? = null,
