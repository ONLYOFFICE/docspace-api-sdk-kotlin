 ...
 *
 * @param type The two-factor authentication type.
 * @param id The ID of the user for whom the TFA settings are being configured.
 * @param trustedIps The list of IP addresses that bypass TFA verification. Each entry is a single address, an inclusive  from-to range or a CIDR block.
