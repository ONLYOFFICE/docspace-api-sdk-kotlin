...
import onlyoffice.docspace.api.sdk.models.RestrictedModelsResponse
 ...
 *
 * @param response The RestrictedModelsResponse object returned by the operation.
...
data class RestrictedModelsResponseWrapper (

    @Json(name = "response")
    val response: RestrictedModelsResponse? = null,
