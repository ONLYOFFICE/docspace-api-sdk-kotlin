...
import onlyoffice.docspace.api.sdk.models.AiLogo
import onlyoffice.docspace.api.sdk.models.AiRoomDataLifetimeDto
import onlyoffice.docspace.api.sdk.models.AiRoomType
import onlyoffice.docspace.api.sdk.models.AiWatermarkDto
...
data class AiFolderDtoInteger (
    ...
    @Json(name = "logo")
    val logo: AiLogo? = null,

    @Json(name = "pinned")
    val pinned: kotlin.Boolean? = null,

    @Json(name = "roomType")
    val roomType: AiRoomType? = null,
    ...
    @Json(name = "lifetime")
    val lifetime: AiRoomDataLifetimeDto? = null,

    @Json(name = "watermark")
    val watermark: AiWatermarkDto? = null,

    @Json(name = "type")
    val type: AiFolderType? = null,
    ...
    val chatSettings: AiChatSettingsDto? = null,

    @Json(name = "rootRoomType")
    val rootRoomType: AiRoomType? = null,
