...
import onlyoffice.docspace.api.sdk.models.BackupServiceStateDto
 ...
 *
 * @param response The BackupServiceStateDto object returned by the operation.
...
data class BackupServiceStateWrapper (

    @Json(name = "response")
    val response: BackupServiceStateDto? = null,
