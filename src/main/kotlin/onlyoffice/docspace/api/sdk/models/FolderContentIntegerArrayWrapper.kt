...
import onlyoffice.docspace.api.sdk.models.FolderContentDtoInteger
 ...
 *
 * @param response The list of FolderContentDtoInteger objects returned by the operation.
...
data class FolderContentIntegerArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<FolderContentDtoInteger>? = null,
