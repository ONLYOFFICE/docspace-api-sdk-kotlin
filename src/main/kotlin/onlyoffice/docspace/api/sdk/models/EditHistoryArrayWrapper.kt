...
import onlyoffice.docspace.api.sdk.models.EditHistoryDto
 ...
 *
 * @param response The list of EditHistoryDto objects returned by the operation.
...
data class EditHistoryArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<EditHistoryDto>? = null,
