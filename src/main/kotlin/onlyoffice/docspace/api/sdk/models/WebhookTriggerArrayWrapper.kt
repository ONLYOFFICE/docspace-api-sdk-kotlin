...
import onlyoffice.docspace.api.sdk.models.WebhookTriggerDto
 ...
 *
 * @param response The list of WebhookTriggerDto objects returned by the operation.
...
data class WebhookTriggerArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<WebhookTriggerDto>? = null,
