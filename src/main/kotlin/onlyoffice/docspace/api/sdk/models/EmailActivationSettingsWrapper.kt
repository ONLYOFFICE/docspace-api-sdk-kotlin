 ...
 *
 * @param response The EmailActivationSettings object returned by the operation.
...
data class EmailActivationSettingsWrapper (

    @Json(name = "response")
    val response: EmailActivationSettings? = null,
