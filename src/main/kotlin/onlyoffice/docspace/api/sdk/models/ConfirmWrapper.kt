...
import onlyoffice.docspace.api.sdk.models.ConfirmDto
 ...
 *
 * @param response The ConfirmDto object returned by the operation.
...
data class ConfirmWrapper (

    @Json(name = "response")
    val response: ConfirmDto? = null,
