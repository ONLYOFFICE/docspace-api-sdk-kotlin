...
import onlyoffice.docspace.api.sdk.models.ItemKeyValuePairBooleanString
 ...
 *
 * @param response The ItemKeyValuePairBooleanString object returned by the operation.
...
data class ItemKeyValuePairBooleanStringWrapper (

    @Json(name = "response")
    val response: ItemKeyValuePairBooleanString? = null,
