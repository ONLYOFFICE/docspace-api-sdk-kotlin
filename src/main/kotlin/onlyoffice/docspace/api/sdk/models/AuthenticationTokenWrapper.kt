...
import onlyoffice.docspace.api.sdk.models.AuthenticationTokenDto
 ...
 *
 * @param response The AuthenticationTokenDto object returned by the operation.
...
data class AuthenticationTokenWrapper (

    @Json(name = "response")
    val response: AuthenticationTokenDto? = null,
