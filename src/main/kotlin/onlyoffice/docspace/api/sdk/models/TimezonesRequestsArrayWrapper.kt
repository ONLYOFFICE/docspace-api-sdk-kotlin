...
import onlyoffice.docspace.api.sdk.models.TimezonesRequestsDto
 ...
 *
 * @param response The list of TimezonesRequestsDto objects returned by the operation.
...
data class TimezonesRequestsArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<TimezonesRequestsDto>? = null,
