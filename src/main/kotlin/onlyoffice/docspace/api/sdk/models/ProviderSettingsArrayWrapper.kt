...
import onlyoffice.docspace.api.sdk.models.ProviderSettingsDto
...
data class ProviderSettingsArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<ProviderSettingsDto>? = null,
