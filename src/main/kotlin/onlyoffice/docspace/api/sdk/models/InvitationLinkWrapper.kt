...
import onlyoffice.docspace.api.sdk.models.InvitationLinkDto
 ...
 *
 * @param response The InvitationLinkDto object returned by the operation.
...
data class InvitationLinkWrapper (

    @Json(name = "response")
    val response: InvitationLinkDto? = null,
