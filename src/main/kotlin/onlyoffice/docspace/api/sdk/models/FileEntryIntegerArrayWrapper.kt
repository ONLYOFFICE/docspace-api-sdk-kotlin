...
import onlyoffice.docspace.api.sdk.models.FileEntryDtoInteger
 ...
 *
 * @param response The list of FileEntryDtoInteger objects returned by the operation.
...
data class FileEntryIntegerArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<FileEntryDtoInteger>? = null,
