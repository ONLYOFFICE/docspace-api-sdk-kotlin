 ...
 *
 * @param name Name of the tool as reported by the MCP server.
 * @param enabled Indicates whether this tool is enabled (true) or disabled (false) for use in AI chat sessions within the room.
 */
