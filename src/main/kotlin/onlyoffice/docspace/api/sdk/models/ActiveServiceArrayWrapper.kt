...
import onlyoffice.docspace.api.sdk.models.ActiveServiceDto
 ...
 *
 * @param response The list of ActiveServiceDto objects returned by the operation.
...
data class ActiveServiceArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<ActiveServiceDto>? = null,
