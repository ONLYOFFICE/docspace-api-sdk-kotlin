...
import onlyoffice.docspace.api.sdk.models.RoomsNotificationSettingsDto
 ...
 *
 * @param response The RoomsNotificationSettingsDto object returned by the operation.
...
data class RoomsNotificationSettingsWrapper (

    @Json(name = "response")
    val response: RoomsNotificationSettingsDto? = null,
