 ...
 *
 * @param response The list of EncryptionKeyDto objects returned by the operation.
...
data class EncryptionKeyArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<EncryptionKeyDto>? = null,
