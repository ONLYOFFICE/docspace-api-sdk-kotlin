...
import onlyoffice.docspace.api.sdk.models.UsageSpaceStatItemDto
 ...
 *
 * @param response The list of UsageSpaceStatItemDto objects returned by the operation.
...
data class UsageSpaceStatItemArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<UsageSpaceStatItemDto>? = null,
