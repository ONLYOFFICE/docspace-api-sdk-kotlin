...
import onlyoffice.docspace.api.sdk.models.AiNewItemsDtoAgentNewItemsDto
 ...
 *
 * @param response The list of NewItemsDtoAgentNewItemsDto objects returned by the operation.
...
data class AiNewItemsAgentNewItemsArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<AiNewItemsDtoAgentNewItemsDto>? = null,
