...
import onlyoffice.docspace.api.sdk.models.CompanyWhiteLabelSettings
 ...
 *
 * @param response The list of CompanyWhiteLabelSettings objects returned by the operation.
...
data class CompanyWhiteLabelSettingsArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<CompanyWhiteLabelSettings>? = null,
