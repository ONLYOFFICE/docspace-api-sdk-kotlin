...
import onlyoffice.docspace.api.sdk.models.DocsCloudTenantInfo
 ...
 *
 * @param response The DocsCloudTenantInfo object returned by the operation.
...
data class DocsCloudTenantInfoWrapper (

    @Json(name = "response")
    val response: DocsCloudTenantInfo? = null,
