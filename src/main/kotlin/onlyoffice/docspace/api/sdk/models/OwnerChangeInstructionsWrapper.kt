...
import onlyoffice.docspace.api.sdk.models.OwnerChangeInstructionsDto
 ...
 *
 * @param response The OwnerChangeInstructionsDto object returned by the operation.
...
data class OwnerChangeInstructionsWrapper (

    @Json(name = "response")
    val response: OwnerChangeInstructionsDto? = null,
