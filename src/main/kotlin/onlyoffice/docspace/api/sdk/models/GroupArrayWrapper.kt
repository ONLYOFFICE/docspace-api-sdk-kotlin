...
import onlyoffice.docspace.api.sdk.models.GroupDto
 ...
 *
 * @param response The list of GroupDto objects returned by the operation.
...
data class GroupArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<GroupDto>? = null,
