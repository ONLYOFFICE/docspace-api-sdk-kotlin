...
data class TenantUserInvitationSettingsRequestDto (

    @Json(name = "allowInvitingMembers")
    val allowInvitingMembers: kotlin.Boolean? = null,

    @Json(name = "allowInvitingGuests")
    val allowInvitingGuests: kotlin.Boolean? = null
