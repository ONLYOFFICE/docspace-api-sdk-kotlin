 ...
 *
 * @param response The list of AuthServiceRequestsDto objects returned by the operation.
...
data class AuthServiceRequestsArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<AuthServiceRequestsDto>? = null,
