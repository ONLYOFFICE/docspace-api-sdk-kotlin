 ...
 *
 * @param response The list of EmployeeDto objects returned by the operation.
...
data class EmployeeArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<EmployeeDto>? = null,
