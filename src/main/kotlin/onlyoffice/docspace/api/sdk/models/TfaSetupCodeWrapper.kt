...
import onlyoffice.docspace.api.sdk.models.TfaSetupCodeDto
 ...
 *
 * @param response The TfaSetupCodeDto object returned by the operation.
...
data class TfaSetupCodeWrapper (

    @Json(name = "response")
    val response: TfaSetupCodeDto? = null,
