...
import onlyoffice.docspace.api.sdk.models.FormsItemDto
 ...
 *
 * @param response The list of FormsItemDto objects returned by the operation.
...
data class FormsItemArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<FormsItemDto>? = null,
