...
import onlyoffice.docspace.api.sdk.models.AiVectorizationSettingsDto
 ...
 *
 * @param response The VectorizationSettingsDto object returned by the operation.
...
data class AiVectorizationSettingsWrapper (

    @Json(name = "response")
    val response: AiVectorizationSettingsDto? = null,
