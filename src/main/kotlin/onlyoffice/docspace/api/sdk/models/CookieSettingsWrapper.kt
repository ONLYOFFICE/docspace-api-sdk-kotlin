...
import onlyoffice.docspace.api.sdk.models.CookieSettingsDto
 ...
 *
 * @param response The CookieSettingsDto object returned by the operation.
...
data class CookieSettingsWrapper (

    @Json(name = "response")
    val response: CookieSettingsDto? = null,
