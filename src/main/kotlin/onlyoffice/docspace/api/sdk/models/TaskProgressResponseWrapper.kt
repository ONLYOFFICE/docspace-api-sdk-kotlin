...
import onlyoffice.docspace.api.sdk.models.TaskProgressResponseDto
 ...
 *
 * @param response The TaskProgressResponseDto object returned by the operation.
...
data class TaskProgressResponseWrapper (

    @Json(name = "response")
    val response: TaskProgressResponseDto? = null,
