...
import onlyoffice.docspace.api.sdk.models.ProviderDto
 ...
 *
 * @param response The list of ProviderDto objects returned by the operation.
...
data class ProviderArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<ProviderDto>? = null,
