...
import onlyoffice.docspace.api.sdk.models.CheckDestFolderDto
 ...
 *
 * @param response The CheckDestFolderDto object returned by the operation.
...
data class CheckDestFolderWrapper (

    @Json(name = "response")
    val response: CheckDestFolderDto? = null,
