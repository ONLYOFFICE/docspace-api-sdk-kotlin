...
import onlyoffice.docspace.api.sdk.models.LoginSettingsDto
 ...
 *
 * @param response The LoginSettingsDto object returned by the operation.
...
data class LoginSettingsWrapper (

    @Json(name = "response")
    val response: LoginSettingsDto? = null,
