 ...
 *
 * @param response The list of FileDtoInteger objects returned by the operation.
...
data class FileIntegerArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<FileDtoInteger>? = null,
