...
import onlyoffice.docspace.api.sdk.models.QuotaSettingsRequestsDtoDefaultQuota
...
data class QuotaSettingsRequestsDto (

    @Json(name = "defaultQuota")
    val defaultQuota: QuotaSettingsRequestsDtoDefaultQuota,
