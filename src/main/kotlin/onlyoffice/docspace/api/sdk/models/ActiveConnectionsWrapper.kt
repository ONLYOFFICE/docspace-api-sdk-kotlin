...
import onlyoffice.docspace.api.sdk.models.ActiveConnectionsDto
 ...
 *
 * @param response The ActiveConnectionsDto object returned by the operation.
...
data class ActiveConnectionsWrapper (

    @Json(name = "response")
    val response: ActiveConnectionsDto? = null,
