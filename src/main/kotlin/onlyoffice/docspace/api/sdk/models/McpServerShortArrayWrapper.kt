...
import onlyoffice.docspace.api.sdk.models.McpServerShortDto
...
data class McpServerShortArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<McpServerShortDto>? = null,
