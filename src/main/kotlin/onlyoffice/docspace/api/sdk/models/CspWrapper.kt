...
import onlyoffice.docspace.api.sdk.models.CspDto
 ...
 *
 * @param response The CspDto object returned by the operation.
...
data class CspWrapper (

    @Json(name = "response")
    val response: CspDto? = null,
