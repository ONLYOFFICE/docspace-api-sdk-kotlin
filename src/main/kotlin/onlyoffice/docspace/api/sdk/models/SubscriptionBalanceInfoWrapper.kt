...
import onlyoffice.docspace.api.sdk.models.SubscriptionBalanceInfo
 ...
 *
 * @param response The SubscriptionBalanceInfo object returned by the operation.
...
data class SubscriptionBalanceInfoWrapper (

    @Json(name = "response")
    val response: SubscriptionBalanceInfo? = null,
