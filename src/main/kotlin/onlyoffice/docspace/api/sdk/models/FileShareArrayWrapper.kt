 ...
 *
 * @param response The list of FileShareDto objects returned by the operation.
...
data class FileShareArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<FileShareDto>? = null,
