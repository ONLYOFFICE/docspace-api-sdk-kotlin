...
import onlyoffice.docspace.api.sdk.models.CapabilitiesDto
 ...
 *
 * @param response The CapabilitiesDto object returned by the operation.
...
data class CapabilitiesWrapper (
    ...
    @Json(name = "response")
    val response: CapabilitiesDto? = null,
