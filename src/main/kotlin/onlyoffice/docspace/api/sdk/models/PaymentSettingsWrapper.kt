...
import onlyoffice.docspace.api.sdk.models.PaymentSettingsDto
 ...
 *
 * @param response The PaymentSettingsDto object returned by the operation.
...
data class PaymentSettingsWrapper (

    @Json(name = "response")
    val response: PaymentSettingsDto? = null,
