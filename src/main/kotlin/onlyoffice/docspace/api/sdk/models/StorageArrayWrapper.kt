...
import onlyoffice.docspace.api.sdk.models.StorageDto
 ...
 *
 * @param response The list of StorageDto objects returned by the operation.
...
data class StorageArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<StorageDto>? = null,
