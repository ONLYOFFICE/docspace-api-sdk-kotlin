 ...
 *
 * @param response The ChunkedUploadSessionResponseInteger object returned by the operation.
...
data class ChunkedUploadSessionResponseIntegerWrapper (

    @Json(name = "response")
    val response: ChunkedUploadSessionResponseInteger? = null,
