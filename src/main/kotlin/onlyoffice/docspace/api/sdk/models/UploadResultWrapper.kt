...
import onlyoffice.docspace.api.sdk.models.UploadResultDto
 ...
 *
 * @param response The UploadResultDto object returned by the operation.
...
data class UploadResultWrapper (

    @Json(name = "response")
    val response: UploadResultDto? = null,
