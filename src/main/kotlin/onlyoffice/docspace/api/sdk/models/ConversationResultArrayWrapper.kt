...
import onlyoffice.docspace.api.sdk.models.ConversationResultDto
 ...
 *
 * @param response The list of ConversationResultDto objects returned by the operation.
...
data class ConversationResultArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<ConversationResultDto>? = null,
