...
import onlyoffice.docspace.api.sdk.models.NotificationSettingsDto
 ...
 *
 * @param response The NotificationSettingsDto object returned by the operation.
...
data class NotificationSettingsWrapper (

    @Json(name = "response")
    val response: NotificationSettingsDto? = null,
