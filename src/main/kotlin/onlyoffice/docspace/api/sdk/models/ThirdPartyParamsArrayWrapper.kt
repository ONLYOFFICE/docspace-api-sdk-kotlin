...
import onlyoffice.docspace.api.sdk.models.ThirdPartyParams
 ...
 *
 * @param response The list of ThirdPartyParams objects returned by the operation.
...
data class ThirdPartyParamsArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<ThirdPartyParams>? = null,
