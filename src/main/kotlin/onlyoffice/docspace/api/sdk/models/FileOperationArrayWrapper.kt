...
import onlyoffice.docspace.api.sdk.models.FileOperationDto
 ...
 *
 * @param response The list of FileOperationDto objects returned by the operation.
...
data class FileOperationArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<FileOperationDto>? = null,
