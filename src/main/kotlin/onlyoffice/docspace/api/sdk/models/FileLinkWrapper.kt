...
import onlyoffice.docspace.api.sdk.models.FileLink
 ...
 *
 * @param response The FileLink object returned by the operation.
...
data class FileLinkWrapper (

    @Json(name = "response")
    val response: FileLink? = null,
