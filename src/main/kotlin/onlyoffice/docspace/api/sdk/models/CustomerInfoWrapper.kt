...
import onlyoffice.docspace.api.sdk.models.CustomerInfoDto
 ...
 *
 * @param response The CustomerInfoDto object returned by the operation.
...
data class CustomerInfoWrapper (

    @Json(name = "response")
    val response: CustomerInfoDto? = null,
