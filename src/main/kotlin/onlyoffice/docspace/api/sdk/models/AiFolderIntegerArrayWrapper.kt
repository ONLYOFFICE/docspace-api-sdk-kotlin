 ...
 *
 * @param response The list of FolderDtoInteger objects returned by the operation.
...
data class AiFolderIntegerArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<AiFolderDtoInteger>? = null,
