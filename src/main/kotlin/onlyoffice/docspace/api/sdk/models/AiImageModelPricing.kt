...
import onlyoffice.docspace.api.sdk.models.AiImagePrice
 ...
 * @param price The price of an image model: per prompt token and per generated image.
...
data class AiImageModelPricing (

    @Json(name = "id")
    val id: kotlin.String?,

    @Json(name = "price")
    val price: AiImagePrice,
