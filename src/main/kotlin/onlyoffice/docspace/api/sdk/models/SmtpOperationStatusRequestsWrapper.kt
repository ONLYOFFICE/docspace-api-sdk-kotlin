...
import onlyoffice.docspace.api.sdk.models.SmtpOperationStatusRequestsDto
 ...
 *
 * @param response The SmtpOperationStatusRequestsDto object returned by the operation.
...
data class SmtpOperationStatusRequestsWrapper (

    @Json(name = "response")
    val response: SmtpOperationStatusRequestsDto? = null,
