...
import onlyoffice.docspace.api.sdk.models.MigrationStatusDto
 ...
 *
 * @param response The MigrationStatusDto object returned by the operation.
...
data class MigrationStatusWrapper (

    @Json(name = "response")
    val response: MigrationStatusDto? = null,
