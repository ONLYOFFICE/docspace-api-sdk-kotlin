...
import onlyoffice.docspace.api.sdk.models.CurrenciesDto
 ...
 *
 * @param response The list of CurrenciesDto objects returned by the operation.
...
data class CurrenciesArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<CurrenciesDto>? = null,
