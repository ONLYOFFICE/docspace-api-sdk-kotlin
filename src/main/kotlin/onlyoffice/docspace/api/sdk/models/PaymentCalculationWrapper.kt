...
import onlyoffice.docspace.api.sdk.models.PaymentCalculation
 ...
 *
 * @param response The PaymentCalculation object returned by the operation.
...
data class PaymentCalculationWrapper (

    @Json(name = "response")
    val response: PaymentCalculation? = null,
