...
import onlyoffice.docspace.api.sdk.models.AiPricesResponse
 ...
 *
 * @param response The AiPricesResponse object returned by the operation.
...
data class AiPricesResponseWrapper (

    @Json(name = "response")
    val response: AiPricesResponse? = null,
