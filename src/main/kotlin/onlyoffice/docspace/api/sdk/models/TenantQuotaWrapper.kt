...
import onlyoffice.docspace.api.sdk.models.TenantQuota
 ...
 *
 * @param response The TenantQuota object returned by the operation.
...
data class TenantQuotaWrapper (

    @Json(name = "response")
    val response: TenantQuota? = null,
