...
import onlyoffice.docspace.api.sdk.models.TenantUserQuotaSettings
 ...
 *
 * @param response The TenantUserQuotaSettings object returned by the operation.
...
data class TenantUserQuotaSettingsWrapper (

    @Json(name = "response")
    val response: TenantUserQuotaSettings? = null,
