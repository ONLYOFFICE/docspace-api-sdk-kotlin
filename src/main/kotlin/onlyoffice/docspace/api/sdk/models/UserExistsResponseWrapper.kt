...
import onlyoffice.docspace.api.sdk.models.UserExistsResponseDto
 ...
 *
 * @param response The UserExistsResponseDto object returned by the operation.
...
data class UserExistsResponseWrapper (

    @Json(name = "response")
    val response: UserExistsResponseDto? = null,
