...
import onlyoffice.docspace.api.sdk.models.CoversResultDto
 ...
 *
 * @param response The list of CoversResultDto objects returned by the operation.
...
data class CoversResultArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<CoversResultDto>? = null,
