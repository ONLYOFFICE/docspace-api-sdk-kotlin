...
import onlyoffice.docspace.api.sdk.models.AiAiSettingsDto
 ...
 *
 * @param response The AiSettingsDto object returned by the operation.
...
data class AiAiSettingsWrapper (

    @Json(name = "response")
    val response: AiAiSettingsDto? = null,
