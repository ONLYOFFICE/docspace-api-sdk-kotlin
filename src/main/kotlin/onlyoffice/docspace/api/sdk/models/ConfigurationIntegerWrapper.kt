...
import onlyoffice.docspace.api.sdk.models.ConfigurationDtoInteger
 ...
 *
 * @param response The ConfigurationDtoInteger object returned by the operation.
...
data class ConfigurationIntegerWrapper (

    @Json(name = "response")
    val response: ConfigurationDtoInteger? = null,
