...
import onlyoffice.docspace.api.sdk.models.XlsxReportResponseDto
 ...
 *
 * @param response The XlsxReportResponseDto object returned by the operation.
...
data class XlsxReportResponseWrapper (

    @Json(name = "response")
    val response: XlsxReportResponseDto? = null,
