 ...
 *
 * @param response The list of GroupSummaryDto objects returned by the operation.
...
data class GroupSummaryArrayWrapper (

    @Json(name = "response")
    val response: kotlin.collections.List<GroupSummaryDto>? = null,
