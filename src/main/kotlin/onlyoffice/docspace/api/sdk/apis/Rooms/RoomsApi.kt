...
import onlyoffice.docspace.api.sdk.models.RoomPrivacyFilter
...
interface RoomsApi {
     ...
     */
    @GET("api/2.0/files/rooms")
    suspend fun getRoomsFolder(@Query("type") type: @JvmSuppressWildcards kotlin.collections.List<RoomType>? = null, @Query("subjectId") subjectId: java.util.UUID? = null, @Query("subjectOwnerId") subjectOwnerId: java.util.UUID? = null, @Query("searchArea") searchArea: SearchArea? = null, @Query("withoutTags") withoutTags: kotlin.Boolean? = null, @Query("tags") tags: kotlin.String? = null, @Query("excludeSubject") excludeSubject: kotlin.Boolean? = null, @Query("provider") provider: ProviderFilter? = null, @Query("quotaFilter") quotaFilter: QuotaFilter? = null, @Query("storageFilter") storageFilter: StorageFilter? = null, @Query("privacyFilter") privacyFilter: RoomPrivacyFilter? = null, @Query("count") count: kotlin.Int? = null, @Query("startIndex") startIndex: kotlin.Int? = null, @Query("sortBy") sortBy: kotlin.String? = null, @Query("sortOrder") sortOrder: SortOrder? = null, @Query("filterValue") filterValue: kotlin.String? = null, @Query("groupId") groupId: kotlin.Int? = null): Response<FolderContentIntegerWrapper>
     ...
     *
     *
     * @param tagName2 The tag being checked. Send the same value as the `tagName` query parameter, which is the one the handler reads.
